...
const sessions = ref([{ is_current_device: true, agent: { platform: 'Windows', browser: 'Chrome', is_desktop: true }, ip_address: '192.168.1.1', last_active: '' }])
    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <div class="flex items-center mt-5">
                ...
                <ActionMessage :on="true" class="ms-3"> Done. </ActionMessage>
            </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        ...
                        <InputError :message="'Logout error'" class="mt-2" />
                    </div>
                </template>
                ...
                <template #footer>
                    ...
                    <PrimaryButton class="ms-3" :class="{ 'opacity-25': false }" :disabled="false" @click="logoutOtherBrowserSessions"> Log Out Other Browser Sessions </PrimaryButton>
                </template>
            </DialogModal>
        </template>
    </ActionSection>
