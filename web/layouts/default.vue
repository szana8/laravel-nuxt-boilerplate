            ...
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="'/websockets'"> Websockets </NavLink>
                            </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                                ...
                                <Dropdown v-if="hasTeamFeatures" align="right" width="60">
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <!-- Team Settings -->
                                            <DropdownLink href="/"> Team Settings </DropdownLink>

                                            <DropdownLink href="/"> Create New Team </DropdownLink>
                            ...
                            <!-- Settings Dropdown -->
                            <div class="ms-3 relative" v-if="loggedIn">
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="'/websockets'" :active="false"> Websockets </ResponsiveNavLink>
                    </div>
